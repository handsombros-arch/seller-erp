        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[14px] font-bold text-[#191F28] mt-1">{event.label}</p>
            </div>
          </div>
          <button onClick={onClose} className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-[#F2F4F6] transition-colors">
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-[13.5px] text-[#6B7684]">입고 예정과 쿠팡 출고 일정을 한눈에 확인하세요</p>
        </div>
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={prevMonth}
            className="w-9 h-9 flex items-center justify-center rounded-xl border border-[#E5E8EB] hover:bg-[#F2F4F6] transition-colors"
          >
            <ChevronLeft className="h-4 w-4 text-[#6B7684]" />
          </button>
          <button
            onClick={goToday}
            className="h-9 px-4 rounded-xl border border-[#E5E8EB] text-[14px] font-bold text-[#191F28] hover:bg-[#F2F4F6] transition-colors min-w-[120px] text-center"
          >
            {year}년 {month}월
          </button>
          <button
          ...
          <button
            onClick={goToday}
            className="h-9 px-3 rounded-xl border border-[#E5E8EB] text-[12.5px] text-[#6B7684] hover:bg-[#F2F4F6] transition-colors"
          >
            오늘
          </button>
        </div>
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          {FILTERS.map((f) => (
            <button
              ...
              className={`h-8 px-3 rounded-xl text-[12.5px] font-medium transition-colors ${
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-1">
                    ...
                    {dayEvents.length > 0 && (
                      <span className="text-[10px] text-[#B0B8C1]">{dayEvents.length}건</span>
                    )}
                  </div>
                  ...
                  <div className="space-y-0.5">
                    {dayEvents.slice(0, 3).map((event) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left px-1.5 py-0.5 rounded-md text-[10.5px] font-medium flex items-center gap-1 truncate ${style.pill} hover:opacity-80 transition-opacity`}
                        >
                    ...
                    {dayEvents.length > 3 && (
                      <p className="text-[10px] text-[#B0B8C1] pl-1">+{dayEvents.length - 3}개 더</p>
                    )}
                  </div>
                </div>
              );
