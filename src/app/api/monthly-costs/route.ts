...
export async function PUT(request: NextRequest) {
  ...
  const TAG_COLS = ['pl_line', 'market', 'alloc_rule', 'carry_forward', 'unit_price', 'vat_none', 'vat_confirmed', 'tax_deductible'];
...
export async function POST(request: NextRequest) {
  ...
  if (body.id) {
    ...
    if (body.tax_deductible !== undefined) update.tax_deductible = !!body.tax_deductible;
