...
export async function GET(request: NextRequest) {
  ...
  const snapQ = async () => {
    let r: any = await admin.from('monthly_cost_snapshots').select('year_month, cost_id, amount, note, ref_amount, ref_source, ref_detail, qty').order('year_month', { ascending: false });
